...
const DemoCart = () => {
    ...
    const [demoList,setDemoList] = useState([{title:"item1",price:"12",quantity:"2"},{title:"item2",price:"122",quantity:"1"},{title:"item3",price:"65",quantity:"4"}]);
    ...
    return (
        <div>
            ...
            <div id="main_cart" >
                <h1 style={{display:"flex", alignItems: "center", justifyContent:"center"}}>Test@test.com's Cart:</h1><br/>
                {demoList.length > 0? <CartList items={demoList}/> : ""}
            </div>
